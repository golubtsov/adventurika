    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="blc-form-login">
                ...
                <form method="POST" action="/server/recover/new_pass.php" class="form-login">
                    <p><label for="password">Придумайте новый пароль<b>*</b></label></p>
                    <p><input type="password" class="pass" name="password" required></p>
                    <p><label for="password2">Подтвердите пароль<b>*</b></label></p>
                    <p><input type="password" class="pass2" name="password2" required></p>
                    <p class="hash"><input type="text" name="hash" value=""></p>
        ...
        <script src="../script/recover/recover.js"></script>
